        ...
        def scrape_data(reader, collection, total_requests, last_row_processed):
            for row in reader:
                try:
                        ...
                        if city_element:
                            ...
                            if population:
                                ...
                                if len(population_elements) >= 4:
                                    ...
                                    residents_value = int(
                                        population_elements[0].find_all('p')[0].text.replace(' ', '').strip())
                                    years_range = \
                                    population_elements[1].find('div', {'class': 'demo-flex'}).find_all('p')[
                                        1].text.strip()
                                    years_range_value = float(
                                        population_elements[1].find('div', {'class': 'demo-flex'}).find_all('p')[
                                            0].text.replace('%', '').replace(',', '.').strip())
                                    residents_km = population_elements[2].find_all('p')[1].text.strip()
                                    residents_km_value = int(
                                        population_elements[2].find_all('p')[0].text.replace(' ', '').replace('\u202f',
                                                                                                              '').strip())
                                    median_age = \
                                    population_elements[3].find('div', {'class': 'demo-flex'}).find_all('p')[
                                        1].text.strip()
                                    median_age_value = \
                                    population_elements[3].find('div', {'class': 'demo-flex'}).find_all('p')[
                                        0].text.strip()
                                if len(population_graphs) >= 2:
                                    ...
                                    from_0_to_14_y_o_value = float(
                                        age[0].find('span', {'class': 'percentage'}).find('span').text.replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    from_15_to_29_y_o = age[1].find('p').text.strip()
                                    from_15_to_29_y_o_value = float(
                                        age[1].find('span', {'class': 'percentage'}).find('span').text.replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    from_30_to_44_y_o = age[2].find('p').text.strip()
                                    from_30_to_44_y_o_value = float(
                                        age[2].find('span', {'class': 'percentage'}).find('span').text.replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    from_45_to_59_y_o = age[3].find('p').text.strip()
                                    from_45_to_59_y_o_value = float(
                                        age[3].find('span', {'class': 'percentage'}).find('span').text.replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    from_60_to_74_y_o = age[4].find('p').text.strip()
                                    from_60_to_74_y_o_value = float(
                                        age[4].find('span', {'class': 'percentage'}).find('span').text.replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    from_75_to_89_y_o = age[5].find('p').text.strip()
                                    from_75_to_89_y_o_value = float(
                                        age[5].find('span', {'class': 'percentage'}).find('span').text.replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    from_90_to_inf_y_o = age[6].find('p').text.strip()
                                    from_90_to_inf_y_o_value = float(
                                        age[6].find('span', {'class': 'percentage'}).find('span').text.replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    # Degree level
                                    ...
                                    no_diploma_value = float(
                                        degree_level[0].find('span', {'class': 'percentage'}).find('span').text.replace(
                                            '%', '').replace(',', '.').strip())
                                    college_certificate = degree_level[1].find('p').text.strip()
                                    college_certificate_value = float(
                                        degree_level[1].find('span', {'class': 'percentage'}).find('span').text.replace(
                                            '%', '').replace(',', '.').strip())
                                    cap_bep = degree_level[2].find('p').text.strip()
                                    cap_bep_value = float(
                                        degree_level[2].find('span', {'class': 'percentage'}).find('span').text.replace(
                                            '%', '').replace(',', '.').strip())
                                    baccalaureate = degree_level[3].find('p').text.strip()
                                    baccalaureate_value = float(
                                        degree_level[3].find('span', {'class': 'percentage'}).find('span').text.replace(
                                            '%', '').replace(',', '.').strip())
                                    bac2_bac4 = degree_level[4].find('p').text.strip()
                                    bac2_bac4_value = float(
                                        degree_level[4].find('span', {'class': 'percentage'}).find('span').text.replace(
                                            '%', '').replace(',', '.').strip())
                                    bac3_bac4 = degree_level[5].find('p').text.strip()
                                    bac3_bac4_value = float(
                                        degree_level[5].find('span', {'class': 'percentage'}).find('span').text.replace(
                                            '%', '').replace(',', '.').strip())
                                    bac5_bac_inf = degree_level[6].find('p').text.strip()
                                    bac5_bac_inf_value = float(
                                        degree_level[6].find('span', {'class': 'percentage'}).find('span').text.replace(
                                            '%', '').replace(',', '.').strip())
                            else:
                                population_title = None,
                                residents = None,
                                residents_value = None,
                                years_range = None,
                                years_range_value = None,
                                residents_km = None,
                                residents_km_value = None,
                                median_age = None,
                                median_age_value = None,
                                age_distribution_title = None,
                                from_0_to_14_y_o = None,
                                from_0_to_14_y_o_value =None,
                                from_15_to_29_y_o = None,
                                from_15_to_29_y_o_value = None,
                                from_30_to_44_y_o = None,
                                from_30_to_44_y_o_value = None,
                                from_45_to_59_y_o = None,
                                from_45_to_59_y_o_value = None,
                                from_60_to_74_y_o = None,
                                from_60_to_74_y_o_value = None,
                                from_75_to_89_y_o = None,
                                from_75_to_89_y_o_value = None,
                                from_90_to_inf_y_o = None,
                                from_90_to_inf_y_o_value = None,
                                degree_level_title = None,
                                no_diploma = None,
                                no_diploma_value = None,
                                college_certificate = None,
                                college_certificate_value = None,
                                cap_bep = None,
                                cap_bep_value = None,
                                baccalaureate = None,
                                baccalaureate_value = None,
                                bac2_bac4 = None,
                                bac2_bac4_value = None,
                                bac3_bac4 = None,
                                bac3_bac4_value = None,
                                bac5_bac_inf = None,
                                bac5_bac_inf_value = None
                            ...
                            if climate is not None:
                                ...
                                if len(climate_value) >= 6:
                                    max_t_value = re.sub(r'\s+', '-', climate_value[1].find('p').text).strip()
                                    median_t_value = re.sub(r'\s+', '-', climate_value[0].find('p').text).strip()
                                    min_t_value = re.sub(r'\s+', '-', climate_value[2].find('p').text).strip()
                                    median_warm_value = re.sub(r'\s+', '-', climate_value[3].find('p').text).strip()
                                    median_rain_value = re.sub(r'\s+', '-', climate_value[4].find('p').text).strip()
                                    median_cold_value = re.sub(r'\s+', '-', climate_value[5].find('p').text).strip()
                                    max_t = max_t_value.replace('-', ' ').strip()
                                    median_t = median_t_value.replace('-', ' ').strip()
                                    min_t = min_t_value.replace('-', ' ').strip()
                                    median_warm = median_warm_value.replace('-', ' ').strip()
                                    median_rain = median_rain_value.replace('-', ' ').strip()
                                    median_cold = median_cold_value.replace('-', ' ').strip()
                            else:
                                climate_title = None
                            ...
                            if economy:
                                ...
                                if len(economy_elements) >= 3:
                                    ...
                                    revenu_value = economy_elements[0].find('div', {'class': 'text-content'}).find(
                                        'p').text.strip() if economy_elements and economy_elements[0] and \
                                                             economy_elements[0] != '-' else None
                                    chomage_title = economy_elements[1].find('p', {'class': 'p-content'}).text.strip()
                                    chomage_value = economy_elements[1].find('div', {'class': 'text-content'}).find(
                                        'p').text.strip()
                                    fibre_title = economy_elements[2].find('p', {'class': 'p-content'}).text.strip()
                                    fibre_value = economy_elements[2].find('div', {'class': 'text-content'}).find(
                                        'p').text.strip()
                                    entreprises_title = economy_elements[3].find('p',
                                                                                 {'class': 'p-content'}).text.strip()
                                    entreprises_value = economy_elements[3].find('div', {'class': 'text-content'}).find(
                                        'p').text.strip() if economy_elements and economy_elements[3] and \
                                                             economy_elements[3] != '-' else None
                            else:
                                economy_title = None
                                revenu_title = None
                                revenu_value = None
                            ...
                            if estate:
                                ...
                                # Price apartment
                                median_price_m2_apartment = estate_price[0].find('div', {'class': 'text-content'}).find(
                                    'p').text.replace('€', '').replace(',', '.').strip()
                                median_price_m2_apartment_value = median_price_m2_apartment.replace(' ', '')
                                price_apartment = re.findall(r'[-+]?\d[\d\s]*(?:\.\d+)?%?',
                                                             median_price_m2_apartment_value)
                                price_apartment_value = int(
                                    price_apartment[0].replace('\u202f', '').replace('-', '').replace('\n',
                                                                                                      '')) if price_apartment and \
                                                                                                              price_apartment[
                                                                                                                  0] and \
                                                                                                              price_apartment[
                                                                                                                  0] != '-' else None
                                ...
                                if percentage_apartment_change:
                                    ...
                                    if percentage_apartment_parts and percentage_apartment_parts[0]:
                                        percentage_apartment_value = float(
                                            percentage_apartment_parts[0].replace('%', '').replace('\u202f',
                                                                                                   '').replace('\n\n',
                                                                                                               ''))
                                median_price_description_m2_apartment = estate_price[0].find('p', {
                                    'class': 'p-content'}).text.strip()
                                # Price mansion
                                median_price_m2_mansion = estate_price[1].find('div', {'class': 'text-content'}).find(
                                    'p').text.replace('€', '').replace(',', '.').strip()
                                ...
                                price_mansion_value = int(
                                    price_mansion[0].replace('\u202f', '').replace('-', '').replace('\n\n',
                                                                                                    '')) if price_mansion and \
                                                                                                            price_mansion[
                                                                                                                0] and \
                                                                                                            price_mansion[
                                                                                                                0] != '-' else None
                                    ...
                                    if percentage_mansion_parts and percentage_mansion_parts[0]:
                                        percentage_mansion_value = float(
                                            percentage_mansion_parts[0].replace('%', '').replace('\u202f', '').replace(
                                                '\n\n', ''))
                                median_price_description_m2_mansion = estate_price[1].find('p', {
                                    'class': 'p-content'}).text.strip()
                                ...
                                if habitat_type_high:
                                    habitat_type_high_value = float(
                                        habitat_type_high.text.replace('%', '').replace(' ', '').replace(',',
                                                                                                         '.').strip())
                                else:
                                    habitat_type_high_value = None
                                # Low value
                                habitat_type_low = habitat_type.find('div', {'class': 'second-circle-content'}).find(
                                    'p').text.replace(' ', '').replace(',', '.').strip()
                                ...
                                if len(estate_use_elements) >= 2:
                                    vacant_housing_value = float(
                                        estate_use_elements[0].find('span').text.replace(' ', '').replace('%',
                                                                                                          '').replace(
                                            ',', '.').strip())
                                    ...
                                    main_residences_value = float(
                                        estate_use_elements[1].find('span').text.replace(' ', '').replace('%',
                                                                                                          '').replace(
                                            ',', '.').strip())
                                    secondary_residences_title = estate_use_elements[2].find('p').text.strip()
                                    secondary_residences_value = float(
                                        estate_use_elements[2].find('span').text.replace(' ', '').replace('%',
                                                                                                          '').replace(
                                            ',', '.').strip())
                                # Estate Rooms
                                ...
                                if len(number_of_rooms_elements) >= 4:
                                    ...
                                    one_room_value = float(
                                        number_of_rooms_elements[0].find('span').text.replace(' ', '').replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    two_rooms_title = number_of_rooms_elements[1].find('p').text.strip()
                                    two_rooms_value = float(
                                        number_of_rooms_elements[1].find('span').text.replace(' ', '').replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    three_rooms_title = number_of_rooms_elements[2].find('p').text.strip()
                                    three_rooms_value = float(
                                        number_of_rooms_elements[2].find('span').text.replace(' ', '').replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    four_rooms_title = number_of_rooms_elements[3].find('p').text.strip()
                                    four_rooms_value = float(
                                        number_of_rooms_elements[3].find('span').text.replace(' ', '').replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                    five_rooms_title = number_of_rooms_elements[4].find('p').text.strip()
                                    five_rooms_value = float(
                                        number_of_rooms_elements[4].find('span').text.replace(' ', '').replace('%',
                                                                                                               '').replace(
                                            ',', '.').strip())
                                # Residents
                                ...
                                rsidents_elements_type3 = rsidents_elements_type2.find('svg',
                                                                                       {'class': 'circular-chart'})
                                # High value
                                residents_high_title = rsidents_elements_type3.find('text',
                                ...
                                # Low value
                                residents_low = rsidents_elements.find('div', {'class': 'second-circle-content'}).find(
                                    'p').text.replace(
                                    ' ', '').replace(',', '.').strip()
                            ...
                            if security:
                                ...
                                security_value = int(security.find('div', {'class': 'security-div'}).find('div', {
                                    'class': 'security-content'}).find('div', {'class': 'city-crime'}).find('p', {
                                    'class': 'security-number'}).text.replace('\u202f', '').strip())
                                security_value_element = security.find('div', {'class': 'security-div'}).find('div', {
                                    'class': 'security-content'}).find('div', {'class': 'city-crime'}).find_all('p')
                                security_value_title = security_value_element[1].text.strip()
                                median_national_element = security.find('div', {'class': 'security-div'}).find('div', {
                                    'class': 'security-content'}).find_all('p')
                                ...
                                crimes_table = security.find('div', {'class': 'security-div'}).find('table').find(
                                    'tbody').find_all('tr')
                                if len(crimes_table) >= 4:
                                    ...
                                    physical_violence_national = int(
                                        physical_violence[1].text.replace('\u202f', '').strip())
                                    physical_violence_local = int(
                                        physical_violence[0].text.replace('\u202f', '').strip())
                            ...
                            if policy:
                                policy_elements = policy.find('div', {'class': 'graph-content'}).find_all('div', {
                                    'class': 'flex-wrapper'})
                                policy_title = policy.find('h2').text.strip()
                                policy_description = policy.find('p').text.strip()
                                # Year one
                                year_1_elements = policy_elements[0].find('div', {'class': 'single-chart'}).find_all(
                                    'div')
                                year_1 = int(policy_elements[0].find('div', {'class': 'single-chart'}).find('div', {
                                    'class': 'year'}).text.strip())
                                winner_value = float(
                                    policy_elements[0].find('div', {'class': 'single-chart'}).find('svg', {
                                        'class': 'circular-chart'}).find('text').text.replace('%', '').replace(',',
                                                                                                               '.').strip())
                                ...
                                if candidate_looser_inf:
                                    ...
                                    looser_value = None
                                # Year two
                                year_2_elements = policy_elements[1].find('div', {'class': 'single-chart'}).find_all(
                                    'div')
                                year_2 = int(policy_elements[1].find('div', {'class': 'single-chart'}).find('div', {
                                    'class': 'year'}).text.strip())
                                winner_value_2 = float(
                                    policy_elements[1].find('div', {'class': 'single-chart'}).find('svg', {
                                        'class': 'circular-chart'}).find('text').text.replace('%', '').replace(',',
                                                                                                               '.').strip())
                                ...
                                # Year three
                                year_3_elements = policy_elements[2].find('div', {'class': 'single-chart'}).find_all(
                                    'div')
                                year_3 = int(policy_elements[2].find('div', {'class': 'single-chart'}).find('div', {
                                    'class': 'year'}).text.strip())
                                winner_value_3 = float(
                                    policy_elements[2].find('div', {'class': 'single-chart'}).find('svg', {
                                        'class': 'circular-chart'}).find('text').text.replace('%', '').replace(',',
                                                                                                               '.').strip())
                                ...
                                # Year four
                                year_4_elements = policy_elements[3].find('div', {'class': 'single-chart'}).find_all(
                                    'div')
                                year_4 = int(policy_elements[3].find('div', {'class': 'single-chart'}).find('div', {
                                    'class': 'year'}).text.strip())
                                winner_value_4 = float(
                                    policy_elements[3].find('div', {'class': 'single-chart'}).find('svg', {
                                        'class': 'circular-chart'}).find('text').text.replace('%', '').replace(',',
                                                                                                               '.').strip())
                    ...
                    traceback.print_exc()
                    print(f"Произошла ошибка: {e} в городе {city_code}")
                    with open('loss.csv', 'a', newline='', encoding='utf-8') as csvfile:
                        writer = csv.writer(csvfile)
                        writer.writerow([city_code])
